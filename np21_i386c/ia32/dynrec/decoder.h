...
static CacheBlockDynRec * CreateCacheBlock(CodePageHandlerDynRec * codepage,PhysPt start,Bitu max_opcodes) {
	...
	while (max_opcodes--) {
		...
		decode.big_addr=CPU_INST_AS32;
		decode.big_op=CPU_INST_OP32;
		decode.seg_prefix=0;
...
//		case 0x61: ARPL missing
		...
		case 0x66:decode.big_op=!CPU_INST_OP32;goto restart_prefix;
		case 0x67:decode.big_addr=!CPU_INST_AS32;goto restart_prefix;

...
uint8_t  mem_readb(const PhysPt ___address) { return cpu_vmemoryread_b(CPU_INST_SEGREG_INDEX, ___address); }
uint16_t mem_readw(const PhysPt ___address) { return cpu_vmemoryread_w(CPU_INST_SEGREG_INDEX, ___address); }
uint32_t mem_readd(const PhysPt ___address) { return cpu_vmemoryread_d(CPU_INST_SEGREG_INDEX, ___address); }

void mem_writeb(const PhysPt ___address, const uint8_t ___val) { cpu_vmemorywrite_b(CPU_INST_SEGREG_INDEX, ___address, (UINT8)(___val)); }
void mem_writew(const PhysPt ___address, const uint16_t ___val) { cpu_vmemorywrite_w(CPU_INST_SEGREG_INDEX, ___address, (UINT16)(___val)); }
void mem_writed(const PhysPt ___address, const uint32_t ___val) { cpu_vmemorywrite_d(CPU_INST_SEGREG_INDEX, ___address, (UINT32)(___val)); }
